 ...
 */
export declare function detect(frame: Frame): DetectedQuadResult[];
/**
 * Detect documents from the the camera preview and return the normalized image of the first detected result
 */
export declare function detectAndNormalize(frame: Frame, config: NormalizationConfig): NormalizedImageResult;
/**
